...
public class tp_05 {
	...
	public static void main(String[] args) {
		...
		public class pangramasWriter extends JFrame {
		    ...
		    private List<Character> teclasDificultad;
		    ...
		    public pangramasWriter() {
		        ...
		        shiftPressed = false;
		        teclasDificultad = new ArrayList<>();
		        ...
		        // Agregar etiquetas en el orden correcto
		        setLayout(new BorderLayout());
		        add(pangramaSeleccionadoLabel, BorderLayout.NORTH);
		        add(new JScrollPane(pangramArea), BorderLayout.CENTER);
		    ...
		    private class KeyboardButtonListener implements ActionListener {
		        ...
		        public void actionPerformed(ActionEvent e) {
		            ...
		            // Manejar la tecla "Limpiar"
		            if ("Limpiar".equals(buttonText)) {
		                textArea.setText(""); // Limpiar el área de texto
		            } else if ("Enter".equals(buttonText)) {
		                textArea.append("\n");
		            } else {
		                // Agregar un espacio en blanco o la letra (mayúscula si Shift está presionada)
		                char tecla = buttonText.length() == 1 ? buttonText.charAt(0) : ' ';
		                textArea.append(isShiftPressed ? String.valueOf(tecla).toUpperCase() : String.valueOf(tecla));

		                // Verificar si la tecla está en el pangrama y no ha sido registrada como dificultad
		                if (pangramaActual.contains(String.valueOf(tecla)) && !teclasDificultad.contains(tecla)) {
		                    teclasDificultad.add(tecla);
		                    System.out.println("Tecla difícil: " + tecla);
		                }
		            }
		        }
		    }
